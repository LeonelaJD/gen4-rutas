    ...
    <%@page import="java.util.*" %>
        <%@page import="com.jimenez.app.rutas.models.*" %>
            <%@page import="java.time.format.*" %>
                ...
                <% Camion camion=(Camion) request.getAttribute("camion"); Boolean estado=camion.getDisponibilidad();
                                        ...
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                                aria-haspopup="true" aria-expanded="false">Rutas<span
                                                    class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="<%=request.getContextPath()%>/rutas/alta">Alta Ruta</a>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="card border">
                                        <ul class="list-group">
                                            <li class="list-ground-item"><strong>Matricula </strong>
                                                <%=camion.getMatricula() %>
                                            </li>
                                            <li class="list-ground-item"><strong>Tipo Camion </strong>
                                                <%=camion.getTipoCamion() %>
                                            </li>
                                            <li class="list-ground-item"><strong>Marca </strong>
                                                <%=camion.getMarca() %>
                                            </li>
                                            <li class="list-ground-item"><strong>Modelo </strong>
                                                <%=camion.getModelo() %>
                                            </li>
                                            <li class="list-ground-item"><strong>Capacidad </strong>
                                                <%=camion.getCapacidad() %>
                                            </li>
                                            <li class="list-ground-item"><strong>Kilometraje </strong>
                                                <%=camion.getKilometraje() %>
                                            </li>
                                            <li class="list-ground-item"><strong>Disponibilidad </strong>
                                                <%= disponible %>
                                            </li>
                                        </ul>
                                    </div>
