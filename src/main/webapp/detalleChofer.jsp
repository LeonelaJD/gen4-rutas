    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card border">
                    <ul class="list-group">
                        <li class="list-ground-item"><strong>Nombre </strong><%=chofer.getNombre() %> </li>
                        <li class="list-ground-item"><strong>Ap. Paterno </strong><%=chofer.getApPaterno() %> </li>
                        <li class="list-ground-item"><strong>Ap. Materno </strong><%=chofer.getApMaterno() %></li>
                        <li class="list-ground-item"><strong>Licencia </strong><%=chofer.getLicencia() %></li>
                        <li class="list-ground-item"><strong>Telefono </strong><%=chofer.getTelefono() %></li>
                        <li class="list-ground-item"><strong>Fecha Nacimiento </strong><%= fecha %></li>
                        <li class="list-ground-item"><strong>Disponibilidad </strong><%= disponible %></li>
                    </ul>
                </div>
            </div>
        </div>
